...
def predict():
    if request.method == "POST":
        ...
        print(make,model,year,km_driven,fuel,reg_city,car_doc,assembly,transmission)
        ...
        cardcenc = int(data["Car documents"][car_doc])
        ...
        res = mymodel.predict([[int(year),int(km_driven),mkenc,mdlenc,flenc,rgctenc,cardcenc,assenc,trenc]])
        print(res[0])
